...
| VM lifecycle policy v2 | done | none | [031](031-vm-lifecycle.md) | Adds policy persistence, CLI, enforcement loop, locked run-budget counter, and telemetry. Shipped at `12c391d`, `d1df12b`, `2202f46`, `80eea77`, `9749f29`, and `cd899a1`. |
