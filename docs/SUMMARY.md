...
* [cove serve (HTTP + MCP)](designs/archive/001-cove-serve-http-mcp.md)
* [Defer create_vm to v0.2](designs/archive/001a-defer-create-vm-to-v02.md)
* [Disks & OCI](designs/archive/002-cove-disks-oci.md)
* [Build & Layer Caching](designs/archive/003-cove-build-oci-caching.md)
...
* [VZScript Host Files](designs/archive/007-vzscript-host-files.md)
* [Codebase Cleanup Plan](designs/archive/008-codebase-cleanup-plan.md)
* [Codebase Refactor Plan](designs/archive/009-codebase-refactor-plan.md)
...
* [NotebookLM Roadmap Refresh](designs/archive/016-notebooklm-roadmap-refresh-2026-04-30.md)
...
* [v0.4 CI Executors (GHA + GitLab)](designs/archive/021-v04-ci-executors-tracks.md)
* [v0.4 Anthropic Adapter](designs/archive/022-v04-anthropic-adapter.md)
