...
| Slice 9 — fleet RBAC / SSO / audit | maybe | started | L | Slice 5 | [046](046-fleet-control-plane.md) §security | Initial persisted controller audit feed, `GET /v1/audit`, service-account records, and bearer-token audit actor binding have landed. Remaining: SAML/OIDC, namespaces, authorization filters, and tamper-evidence hardening. This is the durable governance monetization axis (Teleport line). PAID. |
