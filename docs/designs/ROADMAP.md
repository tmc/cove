...
| Slice 7 — top-k bin-pack scheduler + base-image affinity + fork-warm-pool | maybe | started | L | Slice 5 | [046](046-fleet-control-plane.md) §scheduler | Base-image affinity placement and the first controller image-preparation endpoint have landed; remaining work is top-k bin-pack scoring and fork warm pools. Image-locality is cove's edge over Orchard/Daytona. PAID. |
