...
const (
	...
	guestToolsLaunchDaemonLabel = "com.vz.guest-tools-install"
)
...
<dict>
    <key>Label</key>
    <string>com.vz.guest-tools-install</string>
...
if [ $? -eq 0 ]; then
    ...
    rm -f "$PKG"
    rm -f /Library/LaunchDaemons/com.vz.guest-tools-install.plist
