...
- **orchard has the more mature control plane.** cove's fleet support is CLI
  ...
  placement plus anti-affinity hints and retained placement plans; orchard
  still owns richer controller operations.
...
retained placement plans, but tart and lume still lead in ecosystem maturity,
