...
func TestRuntimeStatusJSON(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: `{"enabled":true,"port":5901,"endpoint":"127.0.0.1:5901","password_protected":true,"service_name":"cove-default","description":"private console","state":"listening"}`,
		},
		{
		...
		},
		{
			...
			want: `{"enabled":true,"kind":"gdb","port":1234,"endpoint":"0.0.0.0:1234","connect":"lldb -o 'gdb-remote 127.0.0.1:1234'","listen_all":true,"state":"listening","description":"kernel debug"}`,
		},
		{
