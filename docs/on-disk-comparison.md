...
- **orchard has the more mature control plane.** cove's fleet support is CLI
  ...
  placement plus anti-affinity hints; orchard still owns richer controller
  operations.
...
least-loaded/image-affinity/bin-pack placement with anti-affinity hints, but
