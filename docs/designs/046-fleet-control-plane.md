...
| 6 | Fleet-wide policy & GC | controller pushes lifecycle policy + image-GC down worker streams; workers report results | PAID | Slice 5 | Fulfills 034-deferred fleet-wide policy; image-GC push has started, lifecycle/storage policy fan-out remains. |
