...
| Slice 9 — fleet RBAC / SSO / audit | maybe | started | L | Slice 5 | [046](046-fleet-control-plane.md) §security | Initial persisted controller audit feed and `GET /v1/audit` have landed. Remaining: SAML/OIDC, service accounts, namespaces, and authorization filters. This is the durable governance monetization axis (Teleport line). PAID. |
