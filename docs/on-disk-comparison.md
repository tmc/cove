...
- **orchard has the more mature control plane.** cove's fleet support is CLI
  ...
  worker capabilities, image provenance, assignment-lease,
...
boundary is present with auto-detected host capability inventory, assignment leases, stale-worker and
