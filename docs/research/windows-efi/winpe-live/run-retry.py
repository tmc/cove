...
root=Path('/tmp/cove-winpe-live-20260907/retry')
...
class Handler(http.server.BaseHTTPRequestHandler):
 ...
 def do_POST(self):
  ...
  reply=b'shift-f10' if index==0 else b''
...
try:runpy.run_path('/tmp/cove-winpe-live-20260907/apple-retry.py',run_name='__main__')
