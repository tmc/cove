...
| Slice 7 — top-k bin-pack scheduler + base-image affinity + fork-warm-pool | maybe | started | L | Slice 5 | [046](046-fleet-control-plane.md) §scheduler | Base-image affinity placement, slot-capped `bin-pack` placement, anti-affinity hints, the first controller image-preparation endpoint, and retained top-k placement plans have landed; remaining work is fork warm pools. Image-locality is cove's edge over Orchard/Daytona. PAID. |
