...
the Homebrew formula or cask must be bumped manually. For a single-maintainer tool
...
# 6. Bump the Homebrew formula or cask manually (see "Manual Homebrew bump" below).
...
# 2. Edit Formula/cove.rb or Casks/cove.rb in tmc/homebrew-tap, updating:
#      version "0.1.4"
