...
cove pull <ref> --dry-run --fetch-manifest --all-platforms --manifest-dir manifests # save full manifest bundle
...
and base disk path. If cove falls back to a fresh partial disk, no base-reuse
line is printed.
