...
operations summary, manifest-bundle-backed digest-aware fleet image preparation with retained history, fleet image-GC push with retained history, lifecycle-policy push, storage budget/prune
