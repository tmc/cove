...
- **Audit log:** single-host `~/.vz/metrics.jsonl` stays MIT; the fleet-wide
  ...
  identities. The remaining work is dynamic OIDC discovery/JWKS refresh and
  SAML identity binding.
