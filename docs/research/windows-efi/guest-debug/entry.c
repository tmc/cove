...
volatile u64 entry_trap[8], entry_saved[8];
...
static EFI_STATUS trace_entry(EFI_HANDLE child) {
    ...
    *entry=original; sync_code(entry);
    ...
    emit(result==1 && entry_trap[0]==(u64)entry && entry_trap[1]==0xf2000007 ? "ENTRY BREAKPOINT PASS\n" : "ENTRY BREAKPOINT INCONCLUSIVE\n");
