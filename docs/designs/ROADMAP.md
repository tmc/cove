...
| Slice 9 — fleet RBAC / SSO / audit | maybe | started | L | Slice 5 | [046](046-fleet-control-plane.md) §security | Initial persisted controller audit feed, `GET /v1/audit`, service-account records, bearer-token audit actor binding, and namespace-scoped assignment/warm-pool/service-account/audit filtering have landed. Remaining: SAML/OIDC, role verbs beyond namespace scope, and tamper-evidence hardening. This is the durable governance monetization axis (Teleport line). PAID. |
