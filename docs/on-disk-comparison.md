...
- **orchard has the more mature control plane.** cove's fleet support is CLI
  ...
  placement; orchard still owns richer controller operations.
...
least-loaded/image-affinity/bin-pack placement, but tart and lume still lead in
