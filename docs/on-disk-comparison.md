...
- **orchard has the more mature control plane.** cove's fleet support is CLI
  ...
  warm-pool quota replenishment; orchard still owns richer controller
  operations.
...
retained placement plans and warm-pool quota replenishment, but tart and lume
