...
- **orchard has the more mature control plane.** cove's fleet support is CLI
  ...
  warm-pool quota replenishment plus agent-ready slot claim into guest `Exec`
  with stop cleanup; orchard still owns richer controller operations.
