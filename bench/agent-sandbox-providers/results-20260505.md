...
| --- | --- | ---: | ---: | ---: | --- |
| openai | default | 10 | n/a | 1.00 | set RUN_LIVE=1 and OPENAI_API_KEY to collect |
| anthropic | claude-opus-4-7 | 10 | n/a | 1.00 | set RUN_LIVE=1 and ANTHROPIC_API_KEY to collect |
| gemini | gemini-2.5-computer-use-preview-10-2025 | 10 | n/a | 1.00 | set RUN_LIVE=1 and GEMINI_API_KEY to collect |
| vertex | gemini-2.5-computer-use-preview-10-2025 | 10 | n/a | 1.00 | set RUN_LIVE=1 and GOOGLE_CLOUD_PROJECT plus ADC to collect |
