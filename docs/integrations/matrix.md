...
| GitLab CI | partial | 021 | Shell / YAML | `vzscripts/gitlab-runner.vzscript` | [`docs/designs/021-v04-ci-executors-tracks.md`](../designs/021-v04-ci-executors-tracks.md), [`vzscripts/gitlab-runner.vzscript`](../../vzscripts/gitlab-runner.vzscript) |
...
| Cirrus migration | shipped v0.4 | docs | CI migration | `docs/migrations/from-cirrus.md` | [`docs/migrations/from-cirrus.md`](../migrations/from-cirrus.md), [`docs/migrations/from-cirrus-checklist.md`](../migrations/from-cirrus-checklist.md) |
