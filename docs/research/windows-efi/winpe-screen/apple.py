...
root=pathlib.Path('/tmp/cove-winpe-screen-20260907')
...
for name in ('screen-shim',):
 img=root/(name+'.img');assert not img.exists()
 source='/tmp/cove-winpe-screen-20260907/screen-base.img'
 ...
 cmd=['/tmp/cove-windows-native-pmu-20260907/probe','-pmu','-efi',str(img),'-graphics','virtio','-nocap','-seconds','30']
