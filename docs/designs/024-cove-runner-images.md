...
the soft-reset isolation result (`015`) —
...
- The soft-reset matrix in `015` recorded
...
- `015` — soft-reset empirical
  (load-bearing for Security).
- `021` — v0.4 CI executors. 024 is
