...
- **orchard has the more mature control plane.** cove's fleet support is CLI
  ...
  provider switch with hosted ComputerTool GUI events, plus persisted
...
switch with hosted ComputerTool GUI events, persisted per-resource sandbox usage
