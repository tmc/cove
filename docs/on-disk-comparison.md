...
- **orchard has the more mature control plane.** cove's fleet support is CLI
  ...
  cleanup; orchard still owns richer controller operations.
...
but tart and lume still lead in ecosystem maturity, and orchard still leads as
a full fleet controller.
